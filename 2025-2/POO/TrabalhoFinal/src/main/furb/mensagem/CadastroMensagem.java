...
public class CadastroMensagem {
	public static void cadastro() {
    	...
    	Mensagem.cadastrarMensagem(16, "O produto deve ter um preço maior que 0 ! \n Produto: %s      Preço: %s ", TipoMensagem.ERROR);
       	...
       	Mensagem.cadastrarMensagem(22, "O valor unitário não pode ser menor que 0! \n Valor: %s", TipoMensagem.ERROR);
       	Mensagem.cadastrarMensagem(23, "Quantidade a movimentar é inválida ! \n Produto: %s       Quantidade Disponível: %s", TipoMensagem.WARNING);
